...
for i in range(n):
    for j in interval(1,n-2): #both included
        for t in interval(1,l):
            ...
            m_c.append(Implies(And(m[i][j][t],h[i][j][t-1]), And(Not(h[i][j+1][t]), Not(h[i][j][t]), h[i][j-1][t], And(h_unchanged_c))))
            m_c.append(Implies(And(m[i][j][t],r[i][j][t-1]), And(Not(r[i][j+1][t]), Not(r[i][j][t]), r[i][j-1][t], And(r_unchanged_c))))
...
for i in range(n):
    for j in interval(1,n-2): #both included
        for t in interval(1,l):
            ...
            m_c.append(Implies(And(m[i][j][t],h[i][j-1][t-1]), And(Not(h[i][j-1][t]), Not(h[i][j+1][t]), h[i][j][t], And(h_unchanged_c))))
            m_c.append(Implies(And(m[i][j][t],r[i][j-1][t-1]), And(Not(r[i][j-1][t]), Not(r[i][j+1][t]), r[i][j][t], And(r_unchanged_c))))
...
for j in range(n):
    for i in interval(1,n-2): #both included
        for t in interval(1,l):
            ...
            m_c.append(Implies(And(m[i][j][t],v[i][j][t-1]), And(Not(v[i][j][t]), Not(v[i+1][j][t]), v[i-1][j][t], And(unchanged_c))))
...
for j in range(n):
    for i in interval(1,n-2): #both included
        for t in interval(1,l):
            ...
            m_c.append(Implies(And(m[i][j][t],v[i-1][j][t-1]), And(Not(v[i-1][j][t]), Not(v[i+1][j][t]), v[i][j][t], And(unchanged_c))))
...
if s.check() == sat:
    ...
    mat = [ [ [(i,j,t,model.evaluate(m[i][j][t])) for t in range(l+1) ]
